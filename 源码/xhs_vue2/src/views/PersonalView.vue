      ...
      <el-container>
        <el-header>
          <el-col :span="2" :offset="0" class="left">
            <div><img src="../assets/xhs_logo.png" width="120" height="50" alt="小红书" /></div>

          </el-col>
          <el-badge :is-dot="isdot" style="float:right">
            <el-button type="danger" icon="el-icon-message" style="font-size:23px;float:right"
              @click="mesVisible = true, isdot = false"></el-button></el-badge>
          <!-- 消息列表 -->
          <mesDialog :Visible="mesVisible" :mesList="message" :likeList="likeList" :userId="userId" :userName="form.name"
            :portrait="imageUrl" @updateVisible="updatemesVisible" />
        </el-header>
        <el-main>
          <el-dialog title="资料修改" :visible.sync="dialogVisible" width="40%" :before-close="handleClose">
            <el-form ref="ruleForm" :model="form" label-position="left" label-width="80px">
              <el-form-item label="头像">
                <el-row>
                  <el-upload class="avatar-uploader" action="#" ref="upload" :limit="1" :show-file-list="true"
                    :auto-upload="false" :on-change="imgHandleChange" :file-list="form.uploadUrl">
              ...
              <el-form-item>
                ...
                <el-button type="danger" @click="dialogVisible = false, submitForm('ruleForm')">保 存</el-button>
              </el-form-item>
            </el-form>
          </el-dialog>
          ...
          <el-dialog 
                          ...
                          <el-form-item>
                            ...
                            <el-button type="primary" @click="editpassVisible = false,submitpass('ruleForm')">保 存</el-button>
                          </el-form-item>
                              </el-form>
                            </el-dialog>
          ...
          <el-row>
            <el-button type="danger" icon="el-icon-edit" round class="edit" size="small"
              @click="dialogVisible = true, getperson()">资料修改</el-button>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="8" :offset="10">
              <div>
                <el-table :data="tableData" style="width:210px">
                  ...
                  <el-table-column prop="liked" label="获赞" width="90" align="center">
                  </el-table-column>
                </el-table>
              </div>
            </el-col>
            ...
            else
            {
              if(this.form.checkpass!=this.form.newpass)
                ...
                else
                {
                  ...
                  axios({
                    method:'put',
                    url: 'http://localhost:8081/'+this.userId+'/PersonalView/password',
        ...
        if (valid) {
          ...
          axios({
            ...
            if (res.data.code != 200) {
              ...
              axios.get('http://localhost:8081/' + this.userId + '/PersonalView')
                .then(response => {
                  this.tableData[0].guanzhu = response.data.data.userInfo.followNum;
                  this.tableData[0].fans = response.data.data.userInfo.fansNum;
                  this.tableData[0].liked = response.data.data.userInfo.likedNum;
