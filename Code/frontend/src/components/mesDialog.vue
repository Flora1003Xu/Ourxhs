        ...
        <div v-for="(mes, index) in mesList" :key="index">
          <el-container>
            <el-aside width="60px">
              <div
                class="block"
                style="margin-top: 10px; margin-left: 0px; padding-left: 0px"
              >
                <el-badge :is-dot="mes.state == 0">
                  <el-avatar
                    :size="45"
                    :src="require('../assets/' + mes.portrait)"
            ...
            <el-aside width="60px">
              <div class="block" style="margin-top: 10px">
                <el-badge :is-dot="like.state == 0">
                  <el-avatar
                    :size="45"
                    :src="require('../assets/' + like.portrait)"
                    style="padding-left: 0px"
                  ></el-avatar
                ></el-badge>
              </div>
...
export default {
  ...
  methods: {
    getMes() {
      axios
        .get("http://localhost:8080/messages/" + this.userId + "/comments")
        .then((response) => {
