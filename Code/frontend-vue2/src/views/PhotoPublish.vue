<template>
    <div class="photoPublish">
        ...
        <el-main>
            <el-row style="margin-top:-20px;">
              <el-col :span="3"><div  style = "font-size:25px;white-space:nowrap;">发布图文<i class="el-icon-picture-outline"></i></div></el-col>
            </el-row><br>

            <el-row>
              <el-col :span="3"><div style ="font-size:20px;transform: scale(1, 0.975);">上传图片</div></el-col>
            </el-row><br>
            ...
            <el-row>
              ...
              <el-form-item style="display: flex;">
                ...
                >
                    ...
                    <div slot="tip" class="el-upload__tip">支持批量上传，上传格式为jpg/png文件，只能上传不超过6张图片</div>
                </el-upload>
            ...
            <el-row><el-col><div style = "width: 500px" >
              <el-input type="text" placeholder="请输入标题" v-model="title" maxlength="20" show-word-limit
              @blur="topicFinished()">
              </el-input></div></el-col>
            </el-row><br>
        
            <TextArea @change="handleChange" @aitelocationList="handleAitelocationList" @aiteList="handleaiteList" @aiteidList="handleaiteidList" ref="textchild"/><br><br><br><br>

            <el-row>
              <el-col :span="3"><div style ="font-size:20px;transform: scale(1, 0.975);">发布设置</div></el-col>
            </el-row><br>
            ...
            <el-row style="text-align: center">
              <el-button round size="medium" @click="submit('form')">发布</el-button>
            </el-row><br>
  ...
  export default {
    ...
    data() {
      return {
        rules: {
          location:[{required:true, message:"请设置自定义地点",trigger:'blur'}],
    ...
    created:function(){
      ...
      this.image={noteID:1,cover:require('../assets/1.jpg'),title:'此为默认标题',portrait:this.authorpicture,creatorName:this.authorname,likedNum:0};
    ...
    methods: {
      ...
      this.questionForm.files.forEach(
						(val, index) => {
              console.log(index)
